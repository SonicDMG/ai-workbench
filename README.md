...
[![Status: Beta · v0.4.0](https://img.shields.io/badge/status-Beta%20%C2%B7%20v0.4.0-f59e0b)](./CHANGELOG.md)
...
> **0.4 is an internal beta.** APIs, schemas, and UI surfaces may
...
> [`docs/whats-new-0.1.0.md`](./docs/whats-new-0.1.0.md).
