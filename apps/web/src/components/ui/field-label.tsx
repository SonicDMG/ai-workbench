...
/**
 * Standalone help tooltip — same visual + a11y treatment as the
 * info icon inside {@link FieldLabel}, but without an attached
 * `<Label>`. Use it next to controls that label themselves
 * (e.g. checkboxes whose own text is the label) so the help text
 * still has a home.
 */
